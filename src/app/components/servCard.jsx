...
function ServCard({header,disc,img}) {
  return (
        <div
            ...
            <Link href={"/"} className='  rounded-full size-14 bg-black hover:bg-main transition-all duration-300 flex  items-center justify-center'><GoArrowUpRight className=' text-xl text-white'/></Link>
        </div>
  )
}
